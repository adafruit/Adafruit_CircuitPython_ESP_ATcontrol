...
URL = "https://api.hackaday.io/v1/projects/1340?api_key="+settings['hackaday_token']
...
while True:
    ...
    #print('-'*40)
    skulls = get_skulls(body)
    if not skulls:
        continue
    print(times, the_time, "skulls:", skulls)
    display.print(int(skulls))

    if last_skulls != skulls:
